...
class TestDevice:
    ...
    def test_upload_pictures(self, get_global_data, set_global_data):
        ...
        try:
            ...
            result_dict = CommonApis().upload_pictures()

            set_global_data("originalUrl", result_dict['originalUrl'])
            set_global_data("picture_name", result_dict['picture_name'])
            set_global_data("picture_size", result_dict['picture_size'])
